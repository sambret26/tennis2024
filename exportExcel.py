...
def addMatch(sheet, matchName, rowNum):
    ...
    if(player1Id and str(winnerId) == str(player1Id)): writeCell(sheet, 7, rowNum, player1)
    elif(player2Id and str(winnerId) == str(player2Id)): writeCell(sheet, 7, rowNum, player2)
